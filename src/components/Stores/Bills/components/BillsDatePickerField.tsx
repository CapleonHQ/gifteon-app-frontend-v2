...
type BillsDatePickerFieldProps = {
  label: string
  value?: Date
...
const BillsDatePickerField = ({
  ...
  const endMonth = maxDay ?? startOfDay(new Date(today.getFullYear() + 10, 11, 31))
      ...
      >
        ...
        <PopoverContent className='w-auto overflow-hidden p-0' align='start'>
          <Calendar
            mode='single'
            selected={value}
            defaultMonth={value ?? minDay ?? today}
            captionLayout='label'
...
export default BillsDatePickerField
